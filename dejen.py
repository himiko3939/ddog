...
def process_account(query):
    ...
    if level_pet >= 41:
        if gold_amount < price_levelup:
            ...
            # Level up code removed
            print(Fore.GREEN + Style.BRIGHT + f"[ Pet ]: Level up skipped because level is sufficient                               "  , flush=True)
    else:
        # Level up code removed
        print(Fore.GREEN + Style.BRIGHT + f"[ Pet ]: Level up skipped because level is insufficient                               "  , flush=True)
